...
import (
	...
	"github.com/gitbus/gitbus/pkg/process"
	"github.com/gitbus/gitbus/pkg/user"
)
...
func getOpenSSHVersion() string {
	...
	// Trim unused information: https://github.com/gitbus/gitbus/issues/4507#issuecomment-305150441
...
func NewContext() {
	...
	// Windows server and OpenSSH version lower than 5.1 (https://github.com/gitbus/gitbus/issues/4507)
